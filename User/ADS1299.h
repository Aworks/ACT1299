...
EXTERN unsigned char init_ADS1x9x (unsigned char device_slot);
EXTERN void Set_ADS1x9x_Chip_Enable (unsigned char device_slot)  ;
EXTERN void Clear_ADS1x9x_Chip_Enable (unsigned char device_slot)  ;
EXTERN void Start_Read_Data_Continuous (unsigned char device_slot);
EXTERN void enable_ADS1x9x_Conversion (unsigned char device_slot);

EXTERN unsigned char ADS1x9x_SPI_Burst (unsigned char device_slot, unsigned char Data);
EXTERN void Power_Up_ADS1x9x (unsigned char device_slot);
EXTERN void Power_Down_ADS1x9x (unsigned char device_slot);
EXTERN void POR_Reset_ADS1x9x (unsigned char device_slot);
EXTERN void Soft_Reset_ADS1x9x (unsigned char device_slot);
EXTERN void Stop_Read_Data_Continuous (unsigned char device_slot);

EXTERN void Soft_Stop_ADS1x9x (unsigned char device_slot);
